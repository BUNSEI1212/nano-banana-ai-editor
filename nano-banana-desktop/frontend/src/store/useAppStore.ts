...
export const useAppStore = create<AppState>()(
  devtools(
    (set, get) => ({
      ...
      setShowSubscriptionPage: (show) => set({ showSubscriptionPage: show }),

      setSelectedTool: (tool) => set({ selectedTool: tool }),

      // Error handling
      showError: (message) => set({ errorMessage: message, showErrorDialog: true }),
      hideError: () => set({ errorMessage: null, showErrorDialog: false }),
